...
Auas 2.0 da ich finde dass das am besten, zum einen übernehmen wir fast die selben Aufgaben wie vom Auas und zum anderen finde ich dass Auas uns stark begleitet hat und ich es nicht schön finde wenn man Unser Auas wegwirft und vergisst.
